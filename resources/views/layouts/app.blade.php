            ...
            <nav style="display:flex; flex-direction:column; gap:2px;">
                ...
                @elseif (auth()->user()->isGrowthSpecialist())
                    ...
                    <div class="nav-sub" id="devSubmenu" style="display:{{ $developmentActive ? 'flex' : 'none' }}; flex-direction:column; gap:2px;">
                        ...
                        <div class="nav-group-label" style="padding-left:18px;">Special Reg &amp; Reg</div>
                        <a href="{{ route('growth-specialist.profiling-mitra') }}" class="nav-item {{ request()->routeIs('growth-specialist.profiling-mitra', 'growth-specialist.profiling-mitra.create', 'growth-specialist.profiling-mitra.edit', 'growth-specialist.profiling-mitra.update') ? 'active' : '' }}" title="Profiling Mitra" style="padding-left:18px;">
                        ...
                        <a href="{{ route('growth-specialist.komit-tracker') }}" class="nav-item {{ request()->routeIs('growth-specialist.komit-tracker*') ? 'active' : '' }}" title="Komit Tracker" style="padding-left:18px;">
                            ...
                            <span class="nav-label">Komit Tracker</span>
                        </a>
                        ...
                        <a href="{{ route('assignment.index') }}" class="nav-item {{ request()->routeIs('assignment.*') ? 'active' : '' }}" title="Assignment" style="padding-left:18px;">
                ...
                <div class="nav-sub" id="salesSubmenu" style="display:{{ $salesActive ? 'flex' : 'none' }}; flex-direction:column; gap:2px;">
                    ...
                    <a href="{{ route('price-adjustment.index') }}" class="nav-item {{ request()->routeIs('price-adjustment.*') ? 'active' : '' }}" title="Price Adjustment">
                        <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="4" y1="21" x2="4" y2="14"/><line x1="4" y1="10" x2="4" y2="3"/><line x1="12" y1="21" x2="12" y2="12"/><line x1="12" y1="8" x2="12" y2="3"/><line x1="20" y1="21" x2="20" y2="16"/><line x1="20" y1="12" x2="20" y2="3"/><line x1="1" y1="14" x2="7" y2="14"/><line x1="9" y1="8" x2="15" y2="8"/><line x1="17" y1="16" x2="23" y2="16"/></svg>
                        <span class="nav-label">Price Adjustment</span>
                    </a>
                </div>
